  ...
  <div
    ...
    <a href="{{ url('/dashboard') }}">
      <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
        <img class="dark:hidden" src="{{ asset('images/logo/DISTRIBUIDORA_3.png') }}" alt="Logo" />
        <img class="hidden dark:block" src="{{ asset('images/logo/DISTRIBUIDORA_2.png') }}" alt="Logo" />
      </span>

      <img
        class="logo-icon"
        :class="sidebarToggle ? 'lg:block' : 'hidden'"
        src="{{ asset('images/logo/icono-logojb.png') }}"
        alt="Logo"
        width="60px"
        />
    </a>
